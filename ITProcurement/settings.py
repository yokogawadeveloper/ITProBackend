...
SECRET_KEY = 'django-insecure-9w9tm2z6##k(e8i(259$%7!qlt(g2mt%x2z)a$ri$t)w8^nbbv'
...
ROOT_URLCONF = 'ITProcurement.urls'
...
WSGI_APPLICATION = 'ITProcurement.wsgi.application'
...
TO_RECEIVER = 'punya.hc@yokogawa.com'
CC_RECEIVER = 'punya.hc@yokogawa.com'
