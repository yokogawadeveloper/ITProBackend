    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DeviceType', models.CharField(blank=True, default='New', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attachment', models.FileField(blank=True, null=True, upload_to='procurement/%Y/%m/%d/%H_%M_%S')),
                ('filetype', models.CharField(blank=True, max_length=100, null=True)),
                ('procurement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='procurement.masterprocurement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('procurement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='inlineitem', to='procurement.masterprocurement')),
            ],
            options={
                'db_table': 'InlineItem',
                'ordering': ['id'],
